    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-32">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/* Left Content */}
            <div>
              <h1 className="text-6xl lg:text-7xl font-light text-slate-900 mb-8 leading-tight">
                Pastor, I have a question:
                <br />
                <span className="text-slate-600 min-h-[1.2em] block">
                  {currentText}
              ...
              <button
                ...
                className="bg-slate-900 text-white px-8 py-4 rounded-full text-lg font-medium tracking-wide hover:bg-slate-800 transition-all duration-300 flex items-center space-x-3 group"
              >
            ...
            <div className="text-right">
              ...
              <div className="flex justify-end space-x-4">
                <div className="bg-white/60 backdrop-blur-sm border border-slate-200/50 px-4 py-2 rounded-full">
                  <span className="text-sm font-medium text-slate-700 tracking-wide">QUESTIONS</span>
                </div>
                <div className="bg-white/60 backdrop-blur-sm border border-slate-200/50 px-4 py-2 rounded-full">
                  <span className="text-sm font-medium text-slate-700 tracking-wide">LIVE CHAT</span>
                </div>
                <div className="bg-white/60 backdrop-blur-sm border border-slate-200/50 px-4 py-2 rounded-full">
                  <span className="text-sm font-medium text-slate-700 tracking-wide">COMMUNITY</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-32">
        <div className="text-center mb-20">
          <h2 className="text-4xl font-light text-slate-900 mb-6">Why This Hits Different</h2>
        ...
        <div className="grid md:grid-cols-3 gap-12">
          <div className="text-center group">
            ...
            <h3 className="text-xl font-medium text-slate-900 mb-4">Ask Anything</h3>
          ...
          <div className="text-center group">
            ...
            <h3 className="text-xl font-medium text-slate-900 mb-4">Live Sessions</h3>
            <p className="text-slate-600 leading-relaxed">
          ...
          <div className="text-center group">
            ...
            <h3 className="text-xl font-medium text-slate-900 mb-4">Safe Space</h3>
            <p className="text-slate-600 leading-relaxed">
      ...
      {/* Stats Section */}
      <div className="bg-white/50 backdrop-blur-sm border-y border-slate-200/50 py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-12 text-center">
            <div>
              <div className="text-5xl font-light text-slate-900 mb-2">500+</div>
              <div className="text-slate-600 tracking-wide">Questions Answered</div>
            </div>
            <div>
              <div className="text-5xl font-light text-slate-900 mb-2">50+</div>
              <div className="text-slate-600 tracking-wide">Live Sessions</div>
            </div>
            <div>
              <div className="text-5xl font-light text-slate-900 mb-2">1000+</div>
              <div className="text-slate-600 tracking-wide">Young People Connected</div>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Newsletter Section */}
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-32">
        <div className="bg-white/60 backdrop-blur-sm border border-slate-200/50 rounded-3xl p-16 text-center">
          <div className="w-12 h-12 bg-gradient-to-br from-teal-100 to-orange-100 rounded-2xl flex items-center justify-center mx-auto mb-8">
            <Sparkles className="h-6 w-6 text-slate-700" />
          </div>
          
          <h2 className="text-3xl font-light text-slate-900 mb-6">Stay Connected</h2>
          ...
          <form onSubmit={handleSubscribe} className="max-w-md mx-auto">
            <div className="flex gap-3">
              <input
                ...
                className="flex-1 px-6 py-4 rounded-full border border-slate-200 focus:outline-none focus:ring-2 focus:ring-slate-300 focus:border-transparent bg-white/80 backdrop-blur-sm"
                required
                disabled={loading}
              />
              <button
                type="submit"
                disabled={loading}
                className="bg-slate-900 text-white px-8 py-4 rounded-full font-medium hover:bg-slate-800 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
